...
class CloudSync:
    ...
    def log_alert(self, alert_type, timestamp, reason=None, details=None):
        """
        ...
        Args:
            ...
            reason: Reason for alert (e.g., "microsleep event", "yawn frequency", etc.)
            details: Dictionary with additional alert details (e.g., microsleep_count, yawn_frequency, etc.)
        """
        try:
            alert_data = {
                'type': alert_type,
